...
export RUN=GEFS && export DTG=2021032506 && export ICDIR=${NPB_WORKDIR}/ICs/${DTG} && export OFFSET_START_HOUR=0
...
#export USE_ATM_PERTURB_FILES=T && export USE_OCN_PERTURB_FILES=T 
